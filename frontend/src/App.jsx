            ...
            <div style={{animation:'slideUp .45s ease-out'}}>
              ...
              <div className="card au" style={{marginBottom:18}}>
                ...
                <div className="rb yl" style={{marginBottom:0,fontSize:14.5,lineHeight:1.85,whiteSpace:'pre-wrap',color:'var(--y)'}}>
                  <ReactMarkdown components={{p: ({children}) => <p style={{color: "var(--text, #ffffff)", fontFamily: "inherit", lineHeight: "1.7", marginBottom: "0", textAlign: "left"}}>{children}</p>, li: ({children}) => <li style={{color: "var(--text, #ffffff)", fontFamily: "inherit", textAlign: "left", marginBottom: "0"}}>{children}</li>, strong: ({children}) => <strong style={{color: "#ffffff", fontFamily: "inherit"}}>{children}</strong>, h1: ({children}) => <h2 style={{color: "#ffffff", fontFamily: "inherit", fontSize: "1rem", marginBottom: "0.5rem"}}>{children}</h2>, h2: ({children}) => <h2 style={{color: "#ffffff", fontFamily: "inherit", fontSize: "1rem", marginBottom: "0.5rem"}}>{children}</h2>, h3: ({children}) => <h3 style={{color: "#ffffff", fontFamily: "inherit", fontSize: "0.95rem"}}>{children}</h3>}}>{result.response}</ReactMarkdown>
                </div>
              </div>
